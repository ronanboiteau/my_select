...
** Last update Fri Dec  4 19:47:34 2015 Ronan Boiteau
*/
...
static unsigned int	_if_not_flag(int fd, unsigned int printed, t_string *str)
{
  int			space;
...
static unsigned int	_flags_handler(int fd,
				       t_flag *flags,
				       t_string *str,
				       va_list ap)
{
